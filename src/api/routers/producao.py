...
from db.manager import DimCultura, DimMunicipio, FatoProducaoConab, FatoProducaoPAM, FatoSigefProducao
...
def get_pam(
    ...
    """
    Obtém dados de produção agrícola municipal (PAM) do IBGE de forma paginada.
...
def get_conab(
    ...
    """
    Obtém as estimativas de safra da CONAB de forma paginada.
...
def get_sigef(
    ...
    """
    Obtém os dados do SIGEF (Sistema de Gestão de Fomento) de forma paginada.
